/* Akvaterm Platform — service worker. RETIRED, and this is the kill switch.
   ...
   stays stuck on old files. In order:
     ...
     3. delete every cache this or any previous version created.
     ...
     5. force every open window to a fresh navigation, so nobody has to
        manually reload to see the effect — with a postMessage fallback for
        the rare engine where client.navigate() is unavailable. */
